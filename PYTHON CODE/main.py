...
fn = r"Users/SOPHADETHRITHYA/Desktop/detectParking-master/datasets/parkinglot_2.mp4"
# /Users/SOPHADETHRITHYA/Desktop/detectParking-master/datasets/parkinglot_1_480p.mp4 

fn_yaml = r"/Users/SOPHADETHRITHYA/Desktop/detectParking-master/datasets/CUHKSquare.yml"
fn_out = r"Users/SOPHADETHRITHYA/Desktop/detectParking-master/datasets/output4.avi"
config = {'save_video': False,
          ...
          'min_area_motion_contour': 500, #150
          'park_laplacian_th': 2,
          'park_sec_to_wait': 1,
          'start_frame': 0} #35000

# Set capture device or file
cap = cv2.VideoCapture("rtsp://admin:asdqwe123@192.168.0.26:80/cam/realmonitor?channel=1&subtype=1")
# 'parkinglot_1_480p.mp4'
...
if config['save_video']:
    ...
    out = cv2.VideoWriter('output4.avi', -1, 25.0, #video_info['fps'], 
...
with open('CUHKSquare.yml', 'r') as stream:
        ...
        for ind, park in enumerate(parking_data):
            ...
            # If status is still different than the one saved and counter is open
                ...
                if video_cur_pos - parking_buffer[ind] > config['park_sec_to_wait']:
                    ...
                    # print("INDEX",ind,"status:",parking_status[ind])
                    location = "parking1/space-"+ str(ind)
                    data = {
                            location : bool(status) }
                    db.update(data)
